...
function getCLIArguments() {
    return yargs
        ...
        .options({
            'd': {
                alias: 'destination',
                default: userSettings['destination'] || Path.resolve(process.cwd(), 'h264'),
            ...
            // },
            // 'log-file': {
            //     default: userSettings['log-file'] || Path.resolve(process.cwd(), 'h264ize.log'),
            //     describe: 'Sets the log file location for all output from h264ize. Enable debug mode via the --debug flag to output to the log file.',
            //     type: 'string',
            //     normalize: true,
            //     group: 'General:'
            // },
            ...
            'test': {
                ...
                describe: 'Puts h264ize in test mode. No files will be encoded.',
                type: 'boolean',
                group: 'Advanced:'
            },
            'version': {
